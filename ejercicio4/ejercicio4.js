...
let title = prompt ( "Ingrese un titulo de libro");
let found = programmingBooks.includes(title);

if ( found) {
    alert("El titulo se encuentra en la lista");
    } else{
        alert ("El titulo no se encuentra en la lista");
}