...
let booxIndex = programmingBooks.indexOf("You Don't Know JS"); 
if (booxIndex !== -1) {
   let shelfNumber = booxIndex + 1 ;
   alert ("El libro You Don't Know JS esta en la estanteria numero" + shelfNumber);
   } else{
    alert(" El libro You Don't Know JS no esta  en la biblioteca")
